    ...
    return Padding(
      ...
      child: Center(
        child: FutureBuilder<List<dynamic>>(
          future: Future.wait([choreService.getChores(), userService.getMe()]),
                  ...
                  SliverPadding(
                    ...
                    sliver: SliverList(
                      delegate: SliverChildListDelegate([
                        ...
                        Text(
                          'Chores completion: $completedCount / $totalCount',
                        ),
                    ...
                    delegate: SliverChildBuilderDelegate(
                      (context, index) {
                        if (actualCount == 0 && index == 0) {
                          return Text(
                            'Congratulations, You are done for today!',
                          ...
                          return ChoreView(
                            ...
                            onTileTap: () => {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => CreateEditChorePage(
                                    choreId: chores[itemIndex].id,
                                  ),
                                ),
                              ),
                            },
